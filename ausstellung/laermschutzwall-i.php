      ...
      <div class="container-fluid mt-40">
        <div class="grid grid-cols-12 relative">
          <div class="col-span-4 col-start-3 font-medium text-lg font-body">
            <h2 class="text-2xl font-heading uppercase">Lärmschutzwall I</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="">
      <div class="container-fluid">
        <div class="grid grid-cols-12 h-full relative items-center">
          <div class="col-span-4 col-start-2 font-medium text-md font-body">
            <div class="relative aspect-[4/5]">
              <picture class="absolute inset-0">
                <source srcset="<?php the_url() ; ?>/assets/laermschutzwall_i-01.webp" type="image/webp">
                <img src="<?php the_url() ; ?>/assets/laermschutzwall_i-01.jpg" alt="Ausstellung" class="w-full h-full object-cover">
              </picture>
            </div>
          </div>
          <div class="col-span-4 col-start-9 font-medium text-md font-body">
            <div class="relative aspect-[4/5]">
              <picture class="absolute inset-0">
                <source srcset="<?php the_url() ; ?>/assets/laermschutzwall_i-02.webp" type="image/webp">
                <img src="<?php the_url() ; ?>/assets/laermschutzwall_i-02.jpg" alt="Ausstellung" class="w-full h-full object-cover">
              </picture>
            </div>
          </div>
