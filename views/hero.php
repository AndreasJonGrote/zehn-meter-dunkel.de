<section class="bg-grey text-light h-[75vh] md:h-[100vh]">
  <div class="container-fluid h-full max-w-screen-lg">
    <div class="flex md:grid grid-cols-12 h-full md:relative items-center">
      ...
      <p class="text-2xl font-heading uppercase col-span-8 relative z-1 mix-blend-difference parallax-item-[0.4]">
        <span>Ein Blick auf </span>
        <span>Dunkel&shy;heit, </span>
        <span>Dist&shy;anz, </span>
        <span>und das Gefühl </span>
        <span>von Unsicher&shy;heit in der Stadt.</span>
      </p>
    </div>
  </div>
</section>